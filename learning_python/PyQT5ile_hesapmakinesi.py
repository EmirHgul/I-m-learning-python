...
class MainForm(QMainWindow):
    ...
    def initUI(self):
        ...
        self.txt_sayi1.move(150,30)      #konum
        self.txt_sayi1.resize(200,32)    # yükseklik ve genişlik
        ...
        self.txt_sayi2.move(150,80)     #konum
        self.txt_sayi2.resize(200,32)      #yükseklik ve genişlik
    ...
    def hesapla(self):
        sender = self.sender().text()         # sender metotu toplama çıkarma çarpma bölme butonlarından hangisine tıklandığını algılar.
        result = 0
